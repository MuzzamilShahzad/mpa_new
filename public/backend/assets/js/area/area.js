$(document).ready(function () {
    ...
    $("#btn-add-area").on("click", function (e) {
        ...
        if (flag) {
            ...
            $("#btn-add-area").addClass('disabled');
            $("#btn-add-area").html('. . . . .');
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("#btn-add-area").removeClass('disabled');
                    $("#btn-add-area").html('Submitted');
                    setTimeout(function () {
                        $(".alert").remove();
                    }, 4000);
                }
    ...
    $("#btn-update-area").on("click", function (e) {
        ...
        if (flag) {
            ...
            $("#btn-update-area").addClass('disabled');
            $("#btn-update-area").html('. . . . .');
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("form").prepend(message);
                    $("#btn-update-area").removeClass('disabled');
                    $("#btn-update-area").html('Updated');
                    setTimeout(function () {
                        $(".alert").remove();
                    }, 4000);
                }
