                                ...
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('system.store') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="tx-semibold">System</label>
                                            <input name="system" class="form-control" type="text" placeholder="Enter System" id="system">
                                        </div>
                                        <button class="btn ripple btn-primary" id="btn-add-system" type="submit">Submit</button>
