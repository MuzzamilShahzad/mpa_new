                            ...
                            <div class="row row-sm">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input name="teacher" class="form-control" type="text" value="{{ $data['teacher']->name }}" placeholder="Enter Teacher Name" id="teacher">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button class="btn ripple btn-primary" id="btn-update-teacher" type="submit">Submit</button>
