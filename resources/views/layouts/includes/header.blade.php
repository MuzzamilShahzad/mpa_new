                ...
                <div class="main-header-left">
                    ...
                    <div class="hor-logo">
                        <a class="main-logo" href="index.html">
                            <img src="{{ url('backend/assets/img/brand/logo.png') }}" class="header-brand-img desktop-logo"
                                alt="logo">
                            <img src="{{ url('backend/assets/img/brand/logo-light.png') }}"
                                ...
                                <!-- <div class="dropdown main-header-notification flag-dropdown">
                                    <a class="nav-link icon text-center" data-bs-target="#country-selector"
                                        ...
                                        <img class="header-icons" alt=""
                                            src="{{ url('backend/assets/img/flags/us_flag.jpg') }}">
                                    </a>
                                </div> -->
                                <!-- country flag -->
                                        ...
                                        <div class="main-notification-list">
                                            <div class="media new">
                                                <div class="main-img-user online">
                                                    <img alt="avatar" src="{{ url('backend/assets/img/users/5.jpg') }}">
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="main-img-user">
                                                    <img alt="avatar" src="{{ url('backend/assets/img/users/2.jpg') }}">
                                                </div>
                                                <div class="media-body">
                                                    <a href="notifications-list.html">
                                            ...
                                            <div class="media">
                                                <div class="main-img-user online">
                                                    <img alt="avatar" src="{{ url('backend/assets/img/users/3.jpg') }}">
                                                </div>
                                                <div class="media-body">
                                                    <a href="notifications-list.html">
                                ...
                                <div class="dropdown d-flex main-profile-menu">
                                    <a class="d-flex" href="javascript:;">
                                        <span class="main-img-user">
                                            <img alt="avatar" src="{{ url('backend/assets/img/users/admin.png') }}">
                                        </span>
                                    </a>
                                    <div class="dropdown-menu">
                                        <div class="header-navheading">
