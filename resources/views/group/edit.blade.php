                        ...
                        <div class="card-body">
                            <div class="row row-sm">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('group.update', $data['group']->id) }}" method="put">
                                    <div class="form-group">
                                            <label class="tx-semibold">Group Name</label>
                                            <input name="group" class="form-control" type="text" value="{{ $data['group']->group }}" id="group">
                                        </div>

                                        <button type="submit" id="btn-update-group" class="btn ripple btn-primary" >Update</button>
