                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2 mt-4">
                                    <div class="form-group">
                                        <button class="btn btn-primary" type="submit" id="btn-search-registeration">Search</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('student.registration.update') }}" method="POST">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="form-number" class="form-label tx-semibold">Registration Number</label>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="form_number" id="form-number" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
